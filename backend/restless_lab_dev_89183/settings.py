"""
Django settings for restless_lab_dev_89183 project.
...
ROOT_URLCONF = 'restless_lab_dev_89183.urls'
...
WSGI_APPLICATION = 'restless_lab_dev_89183.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_lab_dev_89183 API",
    "DESCRIPTION": "API documentation for restless_lab_dev_89183 App",
    "VERSION": "v1",
}
